...
namespace :batch do
  ...
  task :ingest_csv, [:file, :tmp_dir, :investigation_id, :mode] => :environment do |t, args|
    begin
      ...
      if File.exist?(input_file)
        ...
        ingest(json, files_dir, investigation_id, mode)
      else
  ...
  def ingest(json, files_dir, investigation_id, mode)
...
#      begin
        ...
        if mode == "ingest" 
          ...
          file_location = file_attributes["file_location"]
